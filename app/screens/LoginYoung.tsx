  ...
  return (
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.container}>
          ...
          <Text style = {styles.loginText}>espace jeune</Text>
          ...
          {loading ? (
            ...
            <TouchableOpacity
              onPress={() => signInYoung(navigation, email, password, setLoading)}
          ...
          <View style={styles.rowContainer}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('RegisterYoung')}>
